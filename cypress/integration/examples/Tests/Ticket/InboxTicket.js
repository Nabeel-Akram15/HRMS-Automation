...
describe('Ticket inbox visibility of elements', function () {
  ...
  it('Ticket inbox filter', function () {
    ...
    ticket.hardwareCategory().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click()
    ticket.categoryDropDown().click({ force: true })
    ticket.totalTicket().invoke('text').then((text) => {
  ...
  it('Stationary category is showing in tickets', function () {
    ...
    ticket.filterButton().click()
    ticket.categoryDropDown().click({ force: true })
    ticket.stationaryCategory().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    ticket.categoryDropDown().click({ force: true })
  ...
  it('Chairs category is showing', function () {
    ...
    ticket.filterButton().click()
    ticket.categoryDropDown().click({ force: true })
    ticket.chairCategory().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    ticket.categoryDropDown().click({ force: true })
  ...
  it('Others category is showing', function () {
    ...
    ticket.filterButton().click()
    ticket.categoryDropDown().click({ force: true })
    ticket.otherCategory().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    ticket.categoryDropDown().click({ force: true })
  ...
  it('open Status ticket showing', function () {
    ...
    ticket.openStatus().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    ticket.statusDropDown().click({ force: true })
  ...
  it('In Progress Status ticket showing', function () {
    ...
    ticket.filterButton().click()
    ticket.statusDropDown().click({ force: true })
    ticket.inProgressStatus().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    ticket.statusDropDown().click({ force: true })
  ...
  it('Completed Status ticket showing', function () {
    ...
    ticket.filterButton().click()
    ticket.statusDropDown().click({ force: true })
    ticket.completeStatus().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    ticket.statusDropDown().click({ force: true })
  ...
  it('Closed Status ticket showing', function () {
    ...
    ticket.filterButton().click()
    ticket.statusDropDown().click({ force: true })
    ticket.closedStatus().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    ticket.statusDropDown().click({ force: true })
  ...
  it('Critical Priority ticket Shwoing', function () {
    ...
    ticket.criticalPriority().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    ticket.priorityDropDown().click({ force: true })
  ...
  it('High Priority ticket Shwoing', function () {
    ...
    cy.wait(1000)
    ticket.priorityDropDown().click({ force: true })
    ticket.highPriority().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    ticket.priorityDropDown().click({ force: true })
  ...
  it('Medium Priority ticket Shwoing', function () {
    ...
    cy.wait(1000)
    ticket.priorityDropDown().click({ force: true })
    ticket.mediumPriority().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    ticket.priorityDropDown().click({ force: true })
  ...
  it('Low Priority ticket Shwoing', function () {
    ...
    cy.wait(1000)
    ticket.priorityDropDown().click({ force: true })
    ticket.lowPriority().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    ticket.priorityDropDown().click({ force: true })
  ...
  it('Create New Ticket Button visible or working', function () {
    ticket.createNewTicketButton()
      ...
      .click()
    ticket.ticketModalheaderText()
      .should('have.text', 'New Ticket')
  })
