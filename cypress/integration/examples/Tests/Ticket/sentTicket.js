...
describe('Ticket inbox visibility of elements', function () {
  ...
  it('Ticket inbox filter', function () {
    ...
    sentTicket.hardwareCategory().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click()
    sentTicket.categoryDropDown().click({ force: true })
    sentTicket.totalTicket().invoke('text').then((text) => {
  ...
  it('Hardware category is showing', function () {
    ...
    sentTicket.categoryDropDown().click({ force: true })
    sentTicket.hardwareCategory().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    sentTicket.categoryDropDown().click({ force: true })
  ...
  it('Stationary category is showing in tickets', function () {
    ...
    sentTicket.filterButton().click()
    sentTicket.categoryDropDown().click({ force: true })
    sentTicket.stationaryCategory().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    sentTicket.categoryDropDown().click({ force: true })
  ...
  it('Chairs category is showing', function () {
    ...
    sentTicket.filterButton().click()
    sentTicket.categoryDropDown().click({ force: true })
    sentTicket.chairCategory().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    sentTicket.categoryDropDown().click({ force: true })
  ...
  it('Others category is showing', function () {
    ...
    sentTicket.filterButton().click()
    sentTicket.categoryDropDown().click({ force: true })
    sentTicket.otherCategory().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    sentTicket.categoryDropDown().click({ force: true })
  ...
  it('open Status sentTicket showing', function () {
    ...
    sentTicket.openStatus().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    sentTicket.statusDropDown().click({ force: true })
  ...
  it('In Progress Status ticket showing', function () {
    ...
    sentTicket.filterButton().click()
    sentTicket.statusDropDown().click({ force: true })
    sentTicket.inProgressStatus().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    sentTicket.statusDropDown().click({ force: true })
  ...
  it('Completed Status ticket showing', function () {
    ...
    sentTicket.filterButton().click()
    sentTicket.statusDropDown().click({ force: true })
    sentTicket.completeStatus().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    sentTicket.statusDropDown().click({ force: true })
  ...
  it('Closed Status ticket showing', function () {
    ...
    sentTicket.filterButton().click()
    sentTicket.statusDropDown().click({ force: true })
    sentTicket.closedStatus().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    sentTicket.statusDropDown().click({ force: true })
  ...
  it('Critical Priority ticket Shwoing', function () {
    ...
    sentTicket.criticalPriority().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    sentTicket.priorityDropDown().click({ force: true })
  ...
  it('High Priority ticket Shwoing', function () {
    ...
    cy.wait(1000)
    sentTicket.priorityDropDown().click({ force: true })
    sentTicket.highPriority().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    sentTicket.priorityDropDown().click({ force: true })
  ...
  it('Medium Priority ticket Shwoing', function () {
    ...
    cy.wait(1000)
    sentTicket.priorityDropDown().click({ force: true })
    sentTicket.mediumPriority().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    sentTicket.priorityDropDown().click({ force: true })
  ...
  it('Low Priority ticket in Inbox Shwoing', function () {
    ...
    cy.wait(1000)
    sentTicket.priorityDropDown().click({ force: true })
    sentTicket.lowPriority().trigger('mouseover')
      .should('have.css', 'background-color', 'rgb(88, 151, 251)').click().wait(500)
    sentTicket.priorityDropDown().click({ force: true })
  ...
  it('Create New Ticket Button visible or working', function () {
    sentTicket.createNewTicketButton()
      .should('be.visible')
      ...
      .click()
    sentTicket.ticketModalheaderText()
      .should('have.text', 'Ticket Centre')
  })
  ...
  it('CC User Update CC users', function () {
    ...
    cy.get('.ticket-user').children('.ticket-cc').then((ccUsersCount) => {
      console.log('CC users count is' + ccUsersCount.length)
      cy.get(ccUsersCount[0]).children().eq(1).children().eq(0).invoke('text').then((name) => {
        cy.get('.editor').type('@Anas Shahid').find('.rdw-suggestion-dropdown')
          .should('have.text', 'Anas Shahid').click()
        cy.wait(200)
        cy.get('.create-comment > button').click().wait(200)
        cy.get('.ticket-title').children().eq(1).invoke('text').then((ticketTitle) => {
          title = ticketTitle
          ...
          sentTicket.threeDots(1).should('be.visible')
            .and('be.disabled')
        })
      })
    })
...
it.skip('TT-22 By Default open and inProgress ticket should be selected', function () {
  let page = 1
  let ticketnumber = 1
  ticket.totalTicket().invoke('text').then((totalTicketString) => {
